...
*/
@Configuration   //规避上面所描述的问题有两个方案：1、放在appliction（MoviceRibbonApplication）外面(com.yunjipin.comfig)，如果放在主appliction（MoviceRibbonApplication）包以及子包中，则该策略会使用到所有的微服务
                //                            2、
